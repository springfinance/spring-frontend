...
const DepositSection = ({ pool }) => {
  ...
  const depositAssets = (deposit) => {
    ...
    if (deposit.isZap) { // Zap deposit
      const swapAmountOut = pool.zapEstimate.swapAmountOut;
      const swapAmountOutMin = new BigNumber(swapAmountOut - (swapAmountOut * deposit.slippageTolerance));
          ...
          <div class="col-md-12 mb15-xs">
            <div class="box">
              ...
              <a onClick={handleMax} className={classes.balanceMax}>
                {tokenBalance(depositSettings.token.symbol).decimalPlaces(8, BigNumber.ROUND_DOWN).toFormat()}{' '}
              ...
              <dl className={classes.dl}> 
                <dt className={classes.dt}>APY Calculations</dt>
                <dd className={classes.dd}>
                  Farm APR: 150.09% (24.24% daily)
                  <br />Optimal compounds per year: 1111
                  <br />Farm APY: 123.12%
                  <br />Reward APR: 123.12% (12.12% daily)
                  <br />Total APY: 200%
                </dd>
              </dl>
              <dl className={classes.dl}> 
                <dt className={classes.dt}>Fee Calculations</dt>
                <dd className={classes.dd}>
                  Entrance Fee: none
                  <br />Operations: 2.4% (on profits)
                  <br />Gardening: 2.4% (on profits)
                  <br />Buy Back: 2.4% (on profits)
                  <br />Withdrawal Fee: 0.1%
                </dd>
              </dl>
            </div>
          </div>
